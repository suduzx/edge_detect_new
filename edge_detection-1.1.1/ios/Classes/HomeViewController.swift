...
class HomeViewController: UIViewController, ImageScannerControllerDelegate {
        ...
        if self.isBeingPresented {
            ...
            present(cameraController, animated: true) {
                if let window = UIApplication.shared.keyWindow {
                    ...
                    //self.cameraController.setNavigationBarHidden(true, animated: false)
    ...
    lazy var selectPhotoButton: UIButton = {
        ...
        button.setTitle("Xem tất cả", for: .normal)
    ...
    private func setupConstraints() {
        ...
        if #available(iOS 11.0, *) {
            selectPhotoButtonConstraints = [
                selectPhotoButton.widthAnchor.constraint(equalToConstant: 100.0),
