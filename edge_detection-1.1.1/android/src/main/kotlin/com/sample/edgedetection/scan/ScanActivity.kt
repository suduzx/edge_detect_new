...
class ScanActivity : BaseActivity(), IScanView.Proxy {
    ...
    override fun prepare() {
        ...
        //tv_index = initialBundle.getString(EdgeDetectionHandler.SCAN_TITLE) as String
        val textView: TextView = findViewById(R.id.tv_index)
        textView.text = initialBundle.getString(EdgeDetectionHandler.COUNT_IMAGE_CAPTURE) as String + "/10"
...
//        }
        ...
        val ic_back: ImageView = findViewById(R.id.back_icon)
